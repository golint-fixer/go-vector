...
// package filters implements an vector filtering system for block,
...
// for specific LOG events fired by the EVM (Vector Virtual Machine).
...
// filterLoop waits for specific events from vector and fires their handlers
