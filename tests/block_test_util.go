...
func (t *BlockTest) InsertPreState(db vecdb.Database, am *accounts.Manager) (*state.StateDB, error) {
...
/* See https://github.com/vector/tests/wiki/Blockchain-Tests-II

   Whvec a block is valid or not is a bit subtle, it's defined by presence of
