...
/**
 * This method should be used to combine solidity params togvec
...
module.exports = function (str, isNew) {
    if (str.substr(0, 2) === '0x' && !isNew) {
        ...
        console.warn('see https://github.com/vector/web3.js/pull/205');
...
var unitMap = {
    ...
    'nano':         '1000000000',
    'szabo':        '1000000000000',
    'microvec':   '1000000000000',
    'micro':        '1000000000000',
    'finney':       '1000000000000000',
    'millivec':    '1000000000000000',
 ...
 * - kwei       femtovec     ada
 * - mwei       picovec      babbage
 * - gwei       nanovec      shannon      nano
 * - --         microvec     szabo        micro
 * - --         millivec     finney       milli
 * - vec      --             --
 * - kvec                    einstein     grand
 * - mvec
 * - gvec
...
/** @file web3.js
 * @authors:
 *   Jeffrey Wilcke <jeff@vecdev.com>
 *   Marek Kotewicz <marek@vecdev.com>
 *   Marian Oancea <marian@vecdev.com>
 *   Fabian Vogelsteller <fabian@vecdev.com>
 *   Gav Wood <g@vecdev.com>
 * @date 2014
 */

var version = require('./version.json');
var net = require('./web3/methods/net');
var vec = require('./web3/methods/vec');
...
web3.vec.isSyncing = function (callback) {
    return new IsSyncing(callback);
};

/*jshint maxparams:4 */
web3.vec.filter = function (fil, callback) {
    return new Filter(fil, watches.vec(), formatters.outputLogFormatter, callback);
};
/*jshint maxparams:3 */
...
// ADD defaultblock
Object.defineProperty(web3.vec, 'defaultBlock', {
    get: function () {
...
Object.defineProperty(web3.vec, 'defaultAccount', {
    get: function () {
...
setupMethods(web3.vec, vec.methods);
setupProperties(web3.vec, vec.properties);
...
AllSolidityEvents.prototype.execute = function (options, callback) {
    ...
    return new Filter(o, watches.vec(), formatter, callback);
};
...
var checkForContractAddress = function(contract, abi, callback){
    ...
    // wait for receipt
    var filter = web3.vec.filter('latest', function(e){
        if(!e && !callbackFired) {
            count++;
            ...
            if(count > 50) {
                ...
                web3.vec.getTransactionReceipt(contract.transactionHash, function(e, receipt){
                    if(receipt && !callbackFired) {

                        web3.vec.getCode(receipt.contractAddress, function(e, code){
                            /*jshint maxcomplexity: 5 */
...
ContractFactory.prototype.new = function () {
    ...
    if(callback) {
        ...
        web3.vec.sendTransaction(options, function (err, hash) {
            if (err) {
                callback(err);
            } else {
        ...
        var hash = web3.vec.sendTransaction(options);
        // add the transaction hash
        contract.transactionHash = hash;
 ...
 * @return {Object} everything combined togvec and encoded
 */
 ...
 * @file formatters.js
 * @author Marek Kotewicz <marek@vecdev.com>
 * @author Fabian Vogelsteller <fabian@vecdev.com>
 * @date 2015
 */
...
SolidityFunction.prototype.call = function () {
    ...
    if (!callback) {
        var output = web3.vec.call(payload, defaultBlock);
        return this.unpackOutput(output);
    }

    var self = this;
    web3.vec.call(payload, defaultBlock, function (error, output) {
...
SolidityFunction.prototype.sendTransaction = function () {
    ...
    if (!callback) {
        return web3.vec.sendTransaction(payload);
    }

    web3.vec.sendTransaction(payload, callback);
};
...
SolidityFunction.prototype.estimateGas = function () {
    ...
    if (!callback) {
        return web3.vec.estimateGas(payload);
    }

    web3.vec.estimateGas(payload, callback);
};
...
var HttpProvider = function (host) {
    this.host = host || 'http://localhost:1715';
};
...
/**
 * This method should be used to create iban object from vector address
 *
 * @method fromAddress
 * @param {String} address
...
Iban.createIndirect = function (options) {
    return Iban.fromBban('VEC' + options.institution + options.identifier);
};
...
Iban.prototype.isValid = function () {
    return /^XE[0-9]{2}(VEC[0-9A-Z]{13}|[0-9A-Z]{30,31})$/.test(this._iban) &&
...
/// @returns an array of objects describing web3.vec api methods
...
/// @returns an array of objects describing web3.vec api properties
...
/// @returns an array of objects describing web3.vec.filter api methods
var vec = function () {
 ...
 * @author Jeffrey Wilcke <jeff@vecdev.com>
 * @author Marek Kotewicz <marek@vecdev.com>
 * @author Marian Oancea <marian@vecdev.com>
 * @author Fabian Vogelsteller <fabian@vecdev.com>
 ...
 * It's also responsible for polling the vector node for incoming messages
...
RequestManager.prototype.poll = function () {
    /*jshint maxcomplexity: 6 */
    this.timeout = setTimeout(this.poll.bind(this), c.VEC_POLLING_TIMEOUT);
...
var transferToAddress = function (from, to, value, callback) {
    return web3.vec.sendTransaction({
        address: to,
        from: from,
        value: value
    }, callback);
...
;(function (root, factory) {
	...
	var CryptoJS = CryptoJS || (function (Math, undefined) {
	    ...
	    var BufferedBlockAlgorithm = C_lib.BufferedBlockAlgorithm = Base.extend({
	         ...
	         *
	         * @param {boolean} doFlush Whvec all blocks and partial blocks should be processed.
	         *
...
web3.vec.contract = require('./lib/web3/contract');
web3.vec.namereg = namereg.namereg;
web3.vec.ibanNamereg = namereg.ibanNamereg;
web3.vec.sendIBANTransaction = require('./lib/web3/transfer');
web3.vec.iban = require('./lib/web3/iban');
