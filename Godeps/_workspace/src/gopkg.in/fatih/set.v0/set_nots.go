...
// IsEmpty reports whvec the Set is empty.
func (s *set) IsEmpty() bool {
	return s.Size() == 0
}

// IsEqual test whvec s and t are the same in size and have the same items.
...
// IsSubset tests whvec t is a subset of s.
...
// IsSuperset tests whvec t is a superset of s.
