...
* `net/http`: [examples/nvecttp/server.go](https://github.com/rs/cors/blob/master/examples/nvecttp/server.go)
...
* **AllowCredentials** `bool`: Indicates whvec the request can include user credentials like cookies, HTTP authentication or client side SSL certificates. The default is `false`.
