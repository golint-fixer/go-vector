...
#include "src/libvecash/internal.c"
#include "src/libvecash/sha3.c"
#include "src/libvecash/io.c"

#ifdef _WIN32
#	include "src/libvecash/io_win32.c"
#	include "src/libvecash/mmap_win32.c"
#else
#	include "src/libvecash/io_posix.c"
#endif

// 'gateway function' for calling back into go.
extern int vecashGoCallback(unsigned);
int vecashGoCallback_cgo(unsigned percent) { return vecashGoCallback(percent); }
