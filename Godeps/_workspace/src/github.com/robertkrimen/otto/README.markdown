...
Go translates JavaScript-style regular expressions into somvecing that is
...
difficult to provide somvecing like these via Go, but you probably want to wrap
