...
// Whisper represents a dark communication interface through the Vector
...
type Whisper struct {
	...
	expirations map[uint32]*set.SetNonTS  // Message expiration pool (TODO: somvecing lighter)
...
// New creates a Whisper client ready to communicate through the Vector P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
