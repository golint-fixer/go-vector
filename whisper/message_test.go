...
// Tests whvec a message can be wrapped without any identity or encryption.
...
// Tests whvec a message can be signed, and wrapped in plain-text.
...
// Tests whvec a message can be encrypted and decrypted using an anonymous
...
// Tests whvec a message can be properly signed and encrypted.
