...
func handle(id int, conn net.Conn, api shared.VectorApi, c codec.Codec) {
	codec := c.New(conn)
...
// ${protocol}:${path}
// e.g. ipc:/tmp/gvec.ipc
//      rpc:localhost:1715
func ClientFromEndpoint(endpoint string, c codec.Codec) (VectorClient, error) {
