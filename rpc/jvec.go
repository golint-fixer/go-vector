...
import (
	...
	"github.com/vector/go-vector/jsre"
...
type Jvec struct {
	vecApi shared.VectorApi
	re     *jsre.JSRE
	client comms.VectorClient
	fe     xvec.Frontend
}

func NewJvec(vecApi shared.VectorApi, re *jsre.JSRE, client comms.VectorClient, fe xvec.Frontend) *Jvec {
	return &Jvec{vecApi, re, client, fe}
}

func (self *Jvec) err(call otto.FunctionCall, code int, msg string, id interface{}) (response otto.Value) {
...
func (self *Jvec) Send(call otto.FunctionCall) (response otto.Value) {
...
// the user response back to the gvec service
func (self *Jvec) handleRequest(req *shared.Request) bool {
	var err error
	var args []interface{}
...
func (self *Jvec) askPassword(id interface{}, jsonrpc string, args []interface{}) bool {
	var err error
	var passwd string
	if len(args) >= 1 {
...
func (self *Jvec) confirmTransaction(id interface{}, jsonrpc string, args []interface{}) bool {
