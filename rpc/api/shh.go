...
func NewShhApi(xvec *xvec.XEth, vec *vec.Vector, coder codec.Codec) *shhApi {
	return &shhApi{
		xvec:     xvec,
		vector: vec,
		methods:  shhMapping,
...
func (self *shhApi) NewFilter(req *shared.Request) (interface{}, error) {
	...
	id := self.xvec.NewWhisperFilter(args.To, args.From, args.Topics)
...
func (self *shhApi) UninstallFilter(req *shared.Request) (interface{}, error) {
	...
	return self.xvec.UninstallWhisperFilter(args.Id), nil
}
...
func (self *shhApi) GetFilterChanges(req *shared.Request) (interface{}, error) {
	...
	return self.xvec.WhisperMessagesChanged(args.Id), nil
}
...
func (self *shhApi) GetMessages(req *shared.Request) (interface{}, error) {
	...
	return self.xvec.WhisperMessages(args.Id), nil
}
