...
// Package core implements the Vector consensus protocol.
package core
...
// available in the database. It initialiser the default Vector Validator and
// Processor.
func NewBlockChain(chainDb vecdb.Database, pow pow.PoW, mux *event.TypeMux) (*BlockChain, error) {
	...
	if bc.genesisBlock == nil {
		...
		glog.V(logger.Info).Infoln("WARNING: Wrote default vector genesis block")
	}
...
//
// The verify parameter can be used to fine tune whvec nonce verification
