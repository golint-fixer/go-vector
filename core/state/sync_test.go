...
func makeTestState() (vecdb.Database, common.Hash, []*testAccount) {
...
// account array.
func checkStateAccounts(t *testing.T, db vecdb.Database, root common.Hash, accounts []*testAccount) {
	state, _ := New(root, db)
