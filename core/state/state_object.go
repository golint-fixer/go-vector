...
func NewStateObject(address common.Address, db vecdb.Database) *StateObject {
...
func NewStateObjectFromBytes(address common.Address, data []byte, db vecdb.Database) *StateObject {
