...
// Callable method given a `Name` and whvec the method is a constant.
// If the method is `Const` no transaction needs to be created for this
// particular Method call. It can easily be simulated using a local VM.
// For example a `Balance()` method only needs to retrieve somvecing
...
// tests, tests whvec the given input would result in a successful
