 ...
 * @param {String} type
 * @returns {Number} length of dynamic type, 0 or multiplication of VEC_PADDING (32)
 */
var dynamicBytesLength = function (type) {
    if (isArrayType(type) || type === 'bytes')
        return c.VEC_PADDING * 2;
    return 0;
};
...
/** @file formatters.js
 * @authors:
 *   Marek Kotewicz <marek@vecdev.com>
 * @date 2015
 */
...
var formatInputInt = function (value) {
    var padding = c.VEC_PADDING * 2;
    BigNumber.config(c.VEC_BIGNUMBER_ROUNDING_MODE);
...
var formatInputString = function (value) {
    return utils.fromAscii(value, c.VEC_PADDING).substr(2);
};
...
/// required to define VEC_BIGNUMBER_ROUNDING_MODE
var BigNumber = require('bignumber.js');
...
module.exports = {
    VEC_PADDING: 32,
    VEC_SIGNATURE_LENGTH: 4,
    VEC_UNITS: VEC_UNITS,
    VEC_BIGNUMBER_ROUNDING_MODE: { ROUNDING_MODE: BigNumber.ROUND_DOWN },
    VEC_POLLING_TIMEOUT: 1000,
    VEC_DEFAULTBLOCK: 'latest'
};
...
var unitMap = {
    ...
    'kvec':   '1000000000000000000000',
    'grand':    '1000000000000000000000',
    'einstein': '1000000000000000000000',
    'mvec':   '1000000000000000000000000',
    'gvec':   '1000000000000000000000000000',
    'tvec':   '1000000000000000000000000000000'
};
 ...
 * @param {String} unit the unit to convert to, default vec
 * @returns {BigNumber} value of the unit (in Wei)
 * @throws error if the unit is not correct:w
 */
var getValueOfUnit = function (unit) {
    unit = unit ? unit.toLowerCase() : 'vec';
...
/**
 * Takes a number of wei and converts it to any other vec unit.
 *
 * Possible units are:
 * - kwei/ada
 * - mwei/babbage
 ...
 * @param {String} unit the unit to convert from, default vec
 * @return {String|Object} When given a BigNumber object it returns one as well, otherwise a number
*/
    ...
    */
    ...
    function another(configObj) {
        var div,
            ...
            // Whvec BigNumber Errors are ever thrown.
            ERRORS = true,                           // true or false

            // Change to intValidatorNoErrors if ERRORS is false.
            isValidInt = intValidatorWithErrors,     // intValidatorWithErrors/intValidatorNoErrors

            // Whvec to use cryptographically-secure random number generation, if available.
                ...
                out: {
                    ...
                    r = rm < 4
                      ...
                      : rd > 5 || rd == 5 && ( rm == 4 || r || rm == 6 &&
                        ...
                        // Check whvec the digit to the left of the rounding digit is odd.
         ...
         *
         * [z] {boolean|number} Whvec to count integer-part trailing zeros: true, false, 1 or 0.
         */
