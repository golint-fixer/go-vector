...
/* More test vectors:
https://github.com/vector/web3.js/blob/master/test/iban.fromAddress.js
https://github.com/vector/web3.js/blob/master/test/iban.toAddress.js
https://github.com/vector/web3.js/blob/master/test/iban.isValid.js
https://github.com/vector/libvector/blob/develop/test/libveccore/icap.cpp
*/
...
var icapInvalidTests = []icapTest{
	...
	{"IndirectInvalidCheckSum", "", "XE35VECXREGGOPHERSSS"},
	{"IndirectInvalidAssetIdentifier", "", "XE34VECXREGGOPHERSSS"},
	{"IndirectInvalidLength19", "", "XE34VECXREGGOPHERSS"},
	{"IndirectInvalidLength21", "", "XE34VECXREGGOPHERSSSS"},
}
