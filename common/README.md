...
[![Build
Status](https://travis-ci.org/vector/go-vector.png?branch=master)](https://travis-ci.org/vector/go-vector)

The common package contains the vector utility library.

# Installation

As a subdirectory the main go-vector repository, you get it with
`go get github.com/vector/go-vector`.

# Usage

## RLP (Recursive Linear Prefix) Encoding

RLP Encoding is an encoding scheme used by the Vector project. It
encodes any native value or list to a string.

More in depth information about the encoding scheme see the
[Wiki](http://wiki.vector.org/index.php/RLP) article.
...
Patricie Tree is a merkle trie used by the Vector project.

More in depth information about the (modified) Patricia Trie can be
found on the [Wiki](http://wiki.vector.org/index.php/Patricia_Tree).
