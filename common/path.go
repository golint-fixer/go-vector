...
// MakeName creates a node name that follows the vector convention
...
func ExpandHomePath(p string) (path string) {
	...
	// Check in case of paths like "/somvecing/~/somvecing/"
...
func DefaultDataDir() string {
	...
	if home != "" {
		if runtime.GOOS == "darwin" {
			return filepath.Join(home, "Library", "Vector")
...
func DefaultIpcPath() string {
	if runtime.GOOS == "windows" {
		return `\\.\pipe\gvec.ipc`
	}
	return filepath.Join(DefaultDataDir(), "gvec.ipc")
}
