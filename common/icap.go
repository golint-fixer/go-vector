...
// Spec at https://github.com/vector/wiki/wiki/ICAP:-Inter-exchange-Client-Address-Protocol
...
func parseICAP(s string) (Address, error) {
	...
	// checksum is ISO13616, Vector address is base-36
...
func clientIdentToIndirectICAP(instCode, clientIdent string) (string, error) {
	...
	// currently VEC is only valid asset identifier
	s := join("VEC", instCode, clientIdent)
