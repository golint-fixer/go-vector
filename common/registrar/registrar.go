...
/*
Registrar implements the Vector name registrar services mapping
- arbitrary strings to vector addresses
- hashes to hashes
...
// Registrar's backend is defined as an interface (implemented by xvec, but could be remote)
