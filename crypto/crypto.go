...
import (
	...
	"github.com/vector/go-vector/crypto/secp256k1"
...
// Creates an vector address given the bytes and the nonce
...
func decryptPreSaleKey(fileContent []byte, password string) (key *Key, err error) {
	...
	/*
		See https://github.com/vector/pyvecsaletool

		pyvecsaletool generates the encryption key from password by
	...
	*/
	...
	vecPriv := Sha3(plainText)
	ecKey := ToECDSA(vecPriv)
	key = &Key{
		Id:         nil,
		Address:    PubkeyToAddress(ecKey.PublicKey),
		PrivateKey: ecKey,
